...
# Concatenation
list1 = [23, 29, 31, 43, 37, 39, 41]
list2 = [44, 47, 49, 65, 59, 61, 65]
...
# max
my_list = [1, 3, 6, 7, 9, 111, 17, 8]
print(max(my_list))

# min
list_py = [4, 3, 8, 11, 14, 1, 100]
print(min(list_py))
...
# string to list
string_1 = 'shrimad bhagavad gita'
...
# append(element)
list_p = [24, 5, 1988]
new_element = list_p.append(37)
print(list_p)

# extend(iterable)

list_a = [97, 88, 81, 77, 72]
list_b = [10, 15, 11, 13, 19]
new_list = list_a.extend(list_b)
print(new_list)
...
"""End of script and the code blocks"""
